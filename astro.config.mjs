...
export default defineConfig({
  ...
  integrations: [
    ...
    starlight({
      ...
      expressiveCode: {
        shiki: {
          langs: [{ name: "cypher", ...cypherGrammar }],
        },
      },
      head: [
        // Basic OG tags
        ...
        {
          tag: "meta",
          attrs: { property: "og:image", content: site + base + "/img/og.png" },
        },
      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: "Query & visualize your graph",
              link: "/get-started/cypher-intro",
            },
            {
              label: "Run prepared Cypher statements",
              link: "/get-started/prepared-statements",
            },
            {
              label: "Scan data from various sources",
              link: "/get-started/scan",
            },
            {
              label: "Run graph algorithms",
              link: "/get-started/graph-algorithms",
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              items: [
                ...
                {
                  label: "Copy from DataFrame",
                  link: "/import/copy-from-dataframe",
                },
                {
                  label: "Copy from subquery",
                  link: "/import/copy-from-subquery",
                },
          ...
          items: [
            {
              ...
              items: [
                {
                  label: "Intro to Kuzu Explorer",
                  link: "/visualization/kuzu-explorer",
                },
                {
                  label: "Query panel",
                  link: "/visualization/kuzu-explorer/query-panel",
                },
                {
                  label: "Schema panel",
                  link: "/visualization/kuzu-explorer/schema-panel",
                },
                {
                  label: "Import panel",
                  link: "/visualization/kuzu-explorer/import-panel",
                },
                {
                  label: "Settings panel",
                  link: "/visualization/kuzu-explorer/settings-panel",
                },
              ],
            },
            {
              ...
              items: [
                {
                  label: "G.V()",
                  link: "/visualization/third-party-integrations/gdotv",
                  badge: { text: "New" },
                },
                {
                  label: "yFiles Jupyter Graphs",
                  link: "/visualization/third-party-integrations/yfiles",
                  badge: { text: "New" },
                },
              ],
            },
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: "Functions, expressions, & operators",
              link: "/cypher/expressions",
            },
            {
              label: "Data definition language (DDL)",
              link: "/cypher/data-definition",
            },
            {
              label: "Data manipulation clauses",
              link: "/cypher/data-manipulation-clauses",
            },
            { label: "Subqueries", link: "/cypher/subquery" },
            { label: "Macros", link: "/cypher/macro" },
            { label: "Transactions", link: "/cypher/transaction" },
            {
              label: "Attach/Detach to external databases",
              link: "/cypher/attach",
            },
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: ".NET",
              link: "/client-apis/net",
              badge: { text: "Community", variant: "caution" },
            },
            {
              label: "Elixir",
              link: "/client-apis/elixir",
              badge: { text: "Community", variant: "caution" },
            },
            {
              label: "Ruby",
              link: "/client-apis/ruby",
              badge: { text: "Community", variant: "caution" },
            },
            {
              label: "Nim",
              link: "/client-apis/nim",
              badge: { text: "Community", variant: "caution" },
            },
          ],
        },
        ...
        { label: "Connections & concurrency", link: "/concurrency" },
        {
          ...
          items: [
            ...
            },
            {
              ...
              link: "/developer-guide/testing-framework",
            },
            {
              label: "Join order hints",
              link: "/developer-guide/join-order-hint",
            },
            { label: "On-disk files", link: "/developer-guide/files" },
            {
              ...
              items: [
                {
                  label: "Overview",
                  link: "/developer-guide/database-internal",
                },
                {
                  label: "Data types",
                  link: "/developer-guide/database-internal/datatype",
                },
                {
                  label: "Vector types",
                  link: "/developer-guide/database-internal/vector",
                },
                {
                  label: "Execution",
                  link: "/developer-guide/database-internal/execution",
                },
              ],
            },
          ],
            ...
            { label: "Overview", link: "/extensions" },
            {
              ...
              items: [
                ...
                { label: "Google Cloud Storage", link: "/extensions/gcs" },
                {
                  ...
                  link: "/extensions/azure",
                  badge: { text: "New" },
                },
              ],
            },
            {
              label: "External Kuzu databases",
              link: "/extensions/attach/kuzu",
            },
            { label: "Full-text search", link: "/extensions/full-text-search" },
            {
              ...
              items: [
                ...
                { label: "Shortest paths", link: "/extensions/algo/path" },
                {
                  ...
                  link: "/extensions/algo/scc",
                },
                {
                  label: "Weakly Connected Components",
                  link: "/extensions/algo/wcc",
                },
              ],
            },
